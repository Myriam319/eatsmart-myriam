...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 25 sep. 2025 à 22:22
...
--
-- Base de données : `eatsmart_myriam`
--
CREATE DATABASE IF NOT EXISTS `eatsmart_myriam` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `eatsmart_myriam`;
